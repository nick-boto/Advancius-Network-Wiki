...
| Ender Shift    | Unique    | Helmet and Boots | 3         | +15% to get Speed and Absorb when at low HP         |
| Lifebloom      | Unique    | Leggings         | 5         | +10% to heal all allies in 20 block radius on death |
| Arrow Deflect  | Elite     | All armor        | 5         | +5% to take no dmg from arrows                      |
| Frozen         | Elite     | All armor        | 5         | +3% to give Slow I when hit                         |
| Hardened       | Elite     | All armor        | 5         | +5% to regen durability when dmged                  |
| Stormcaller    | Elite     | All armor        | 4         | +5% to strike lightning when hit                    |
| Voodoo         | Elite     | All armor        | 5         | +3% to give Weak I when hit                         |
| Ender Walker   | Elite     | Boots            | 5         | +6% to clear Wither & Poison when hit               |
| Escapist       | Elite     | Boots            | 5         | +10% to get Speed 4 when at low HP                  |
| Reinforced     | Ultimate  | All armor        | 5         | +4% to take half dmg when hit from behind           |
| Implants       | Ultimate  | Helmet           | 10        | +5% to get +1 HP and +1 hunger every 3 sec          |
| Undead Ruse    | Ultimate  | Boots            | 10        | +3% to summon zombies to defend you when hit        |
| Angelic        | Legendary | All armor        | 5         | +1% to get +2 hearts when hit                       |
| Bliss          | Legendary | Helmet           | 5         | +5% to get Regen 3 at low HP                        |
| Wolves         | Legendary | Plate            | 10        | +3% to summon wolves to defend you when hit         |
| Saturated      | Legendary | Leggings         | 1         | Perma Saturation                                    |
| Metaphysical   | Legendary | Boots            | 10        | +3% to remove Slow, Poison, and Weak when hit       |
| Firework       | Heroic    | All armor        | 5         | +10% to get Resist 2 at low HP                      |
| Diver          | Heroic    | Helmet           | 1         | Perma Water Breath 1                                |
| Lumen          | Heroic    | Helmet           | 1         | Perma Nightlight 1                                  |
| Barrier        | Heroic    | Plate            | 5         | +10% to take no dmg from explosions                 |
| Ward           | Heroic    | Plate            | 5         | +1% to take no dmg from hits                        |
| Overload       | Mythical  | Helmet           | 3         | Perma +2 Health Up hearts                           |
| Mighty         | Mythical  | Plate            | 1         | Perma Strength 1                                    |
| Tough          | Mythical  | Plate            | 1         | Perma Resist 1                                      |
| Extinguish     | Mythical  | Leggings         | 1         | Perma Fire Resist 1                                 |
...
| Archaeology    | Elite     | Spade          | 10        | +5% to get artifacts at /digsite              |
| Lucky Fisher   | Elite     | Rod            | 10        | +5% to get 120% EXP on fish catch             |
| Dirt Poor      | Ultimate  | Spade          | 1         | Auto-sell all dirt at /digsite                |
| Shiny Catch    | Ultimate  | Rod            | 5         | +5% to get gems on fish catch                 |
| Obsidian Miner | Ultimate  | Pick           | 1         | Insta-mine obsidian                           |
| Dust Catcher   | Legendary | Rod            | 3         | +0.5% to get random magic dust on fish catch  |
| Dust Chopper   | Legendary | Axe            | 3         | +0.5% to get random magic dust on block break |
| Immortal       | Mythical  | Pick and Spade | 1         | Unbreakable                                   |
